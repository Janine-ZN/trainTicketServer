...
import com.cn.common.database.BatchPreparedStatementSetter;
 ...
 * 数据访问基类
 */
public class DataAccessorSupportTwo 
implements DataAccessor {

	
	@Autowired
	protected JdbcTemplateTwo jdbcTemplateTwo;
	 ...
	 */
	public JdbcTemplateTwo getJdbcTemplateTwo() {
		return jdbcTemplateTwo;
	}
	 ...
	 * 设置jdbcTemplateTwo
	 * 
	 * @param jdbcTemplateTwo
	 */
	public void setJdbcTemplateTwo(JdbcTemplateTwo jdbcTemplateTwo) {
	...
	public void executeNoQuery(String sql) throws DaoException {
		try {
			jdbcTemplateTwo.execute(preExecute(sql));
	...
	throws DaoException {
		int affect = 0;
		try {
			affect = jdbcTemplateTwo.update(preExecute(sql), args, argTypes);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return affect;
	...
	throws DaoException {
		int affect = 0;
		try {
			affect = jdbcTemplateTwo.update(preExecute(sql), params);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return affect;
	...
	public int executeUpdate(String sql) throws DaoException {
		int affect = 0;
		try {
			affect = jdbcTemplateTwo.update(preExecute(sql));
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return affect;
	...
	throws DaoException {
		int[] affects;
		try {
			affects = jdbcTemplateTwo.batchUpdate(preExecute(sqls));
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return affects;
	...
	throws DaoException {
		int[] affects;
		try {
			affects = jdbcTemplateTwo.batchUpdate(preExecute(sql), setter);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return affects;
	...
	throws DaoException {
		T result = null;
		try {
			result = jdbcTemplateTwo.queryForObject(preExecute(sql), rowMapper, params);
	...
	throws DaoException {
		T result = null;
		try {
			result = jdbcTemplateTwo.queryForObject(preExecute(sql), requiredType);
		} catch (EmptyResultDataAccessException erdae) {
			result = null;
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
	...
	throws DaoException {
		T result = null;
		try {
			result = jdbcTemplateTwo.queryForObject(preExecute(sql), args, requiredType);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return result;
	...
	public String queryForString(String sql, String defaultValue, Object ...params) {
		String value = defaultValue;
		try {
			value = jdbcTemplateTwo.queryForObject(preExecute(sql), params, String.class);
	...
	public long queryForDouble(String sql, long defaultValue, Object ...params) {
		...
		try {
			Number number = jdbcTemplateTwo.queryForObject(preExecute(sql), params, Long.class);
			if (number != null) {
	...
	public int queryForInt(String sql, int defaultValue, Object ...params) {
		...
		try {
			Number number = jdbcTemplateTwo.queryForObject(preExecute(sql), params, Integer.class);
			if (number != null) {
	...
	throws DaoException {
		List<T> results = jdbcTemplateTwo.query(preExecute(sql), rowMapper, params);
		if (results != null && results.size() > 0) {
			return results.get(0);
		}
		return null;
	...
	throws DaoException {
		List<T> rows = null;
		try {
			rows = jdbcTemplateTwo.query(preExecute(sql), args, argTypes, rowMapper);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
	...
	throws DaoException {
		List<T> rows = null;
		try {
			rows = jdbcTemplateTwo.query(preExecute(sql), rowMapper);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return rows == null ? new ArrayList<T>() : rows;
	...
	throws DaoException {
		List<T> rows = null;
		try {
			rows = jdbcTemplateTwo.query(preExecute(sql), rowMapper, args);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return rows == null ? new ArrayList<T>() : rows;
	...
	throws DaoException {
		T result = null;
		try {
			result = jdbcTemplateTwo.query(preExecute(sql), args, rse);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return result;
	...
	throws DaoException {
		T result = null;
		try {
			result = jdbcTemplateTwo.query(preExecute(sql), ree, params);
		} catch (DataAccessException dae) {
			throw new DaoException(dae);
		}
		return result;
